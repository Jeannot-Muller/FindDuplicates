...
Begin Window Window1
   ...
   Begin Label lbInput1
      ...
      TabIndex        =   5
      TabPanelIndex   =   0
      Text            =   "Main input to compare against duplicates in ..."
      TextAlign       =   0
      TextColor       =   &c00000000
      TextFont        =   "System"
      TextSize        =   0.0
...
#tag Events pbSearch
	#tag Event
		Sub Action()
		  ...
		  Dim array2() as string = ReplaceLineEndings(input2,EndOfLine).Split(EndOfLine)
		  ...
		  // write the results
		  TAduplicates.Text = Join(duplicates, EndOfLine)
